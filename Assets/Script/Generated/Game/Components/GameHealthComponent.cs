...
public partial class GameEntity {
    ...
    public void AddHealth(int newTotal, int newCurrent, int newRecoverable) {
        ...
        component.recoverable = newRecoverable;
        AddComponent(index, component);
    }

    public void ReplaceHealth(int newTotal, int newCurrent, int newRecoverable) {
        var index = GameComponentsLookup.Health;
        var component = (HealthComponent)CreateComponent(index, typeof(HealthComponent));
        component.total = newTotal;
        component.current = newCurrent;
